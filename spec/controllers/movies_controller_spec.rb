...
describe MoviesController  do
	describe 'find movie with same director' do
		it 'should call the model method that performs a search for movies with the same director' do
			Movie.should_receive(:find_movie_with_same_director).with('George Lucas')
			get :find_movie_with_same_director, {:search_terms => 'George Lucas'}
		end
		it 'should select the search results for rendering'
